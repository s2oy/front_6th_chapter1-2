...
describe("Chapter1-2 > 기본과제 > 가상돔 만들기 > ", () => {
  describe("createVNode > ", () => {
    ...
    // NOTE: 실제 React에서는 평탄화 처리하지 않음, 중첩하여 트랜스파일링함.
    it("자식 배열을 평탄화해야 한다", () => {
      const vNode = createVNode("div", null, ["Hello", ["world", "!", ["1"]]]);
      expect(vNode.children).toEqual(["Hello", "world", "!", "1"]);
    });
      ...
      it.each([
        {
          name: "기본적인 단일 엘리먼트",
          vNode: <div>Hello</div>,
          expected: createVNode("div", null, "Hello"),
        },
        {
          name: "속성이 있는 엘리먼트",
          vNode: (
          ...
          expected: createVNode("div", { id: "test", className: "container" }, "Content"),
        },
        {
          name: "중첩된 엘리먼트",
          vNode: (
          ...
          expected: createVNode("div", { id: "parent" }, createVNode("span", { className: "child" }, "Child")),
        },
        {
          name: "배열 렌더링",
          vNode: (
          ...
          expected: createVNode(
            "ul",
            null,
            createVNode("li", { key: 1 }, "Item ", 0, ": ", 1),
            createVNode("li", { key: 2 }, "Item ", 1, ": ", 2),
            createVNode("li", { key: 3 }, "Item ", 2, ": ", 3),
          ),
        },
        {
          name: "함수형 컴포넌트",
          vNode: <TestComponent message="Hello World" />,
          expected: createVNode(TestComponent, { message: "Hello World" }),
        },
        {
          name: "이벤트 핸들러가 있는 엘리먼트",
          vNode: <button onClick={() => {}}>Click</button>,
          expected: createVNode("button", { onClick: expect.any(Function) }, "Click"),
        },
        {
          name: "조건부 렌더링",
          vNode: (
          ...
          expected: createVNode("div", null, createVNode("span", null, "Shown")),
        },
        {
          name: "복잡한 컴포넌트 구조",
          vNode: (
          ...
          expected: createVNode(ComplexComponent, {
            items: [
              { id: 1, text: "First" },
              { id: 2, text: "Second" },
            ],
        ...
        },
        {
          ...
          expected: createVNode("div", null, null, undefined, createVNode("span", null, "Valid")),
        },
      ])("$name", ({ vNode, expected }) => {
        console.log(vNode, expected);
